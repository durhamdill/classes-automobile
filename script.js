...
let mazda3 = new Car(model = "Mazda3", doors = 4, color = "Red", enginetype = "Hybrid", transmission = "Automatic", trim = "Touring", wheelstrim = "Base", audio = "Premium", seatstrim = "Leather", moonroof = true);
...
let miataRf = new Sport(model = "Miata-RF", trim = "Grand Touring", transmission = "Manual", top = "Hard top", color = "Red", seats = "Leather", audio = "Premium", wheelstrim = "Premium");
